...
<head>
    ...
    <style>
        ...
        .overlay {
            ...
            width: 100%;
            height: 100%;
            background-color: rgba(241, 238, 139, 0.034);
            z-index: -1;
        }
        ...
        .container {
            ...
            margin: 20px auto;
            padding: 20px;
            background-color: rgba(201, 235, 238, 0.411);s
            border-radius: 15px;
        ...
        h1 {
            font-size: 4.5rem;
            margin-bottom: 10px;
            text-shadow: 2px 2px 4px rgb(63, 6, 47);
            color: #ffffff;
        }
        ...
        .question-content {
            background: linear-gradient(to bottom, #e5f4f5, #b2f6f6);
            padding: 30px;
            border-radius: 15px;
            max-width: 800px;
            width: 90%;
